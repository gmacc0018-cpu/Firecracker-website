const fs = require('fs');
const { categories, products } = JSON.parse(fs.readFileSync('scratch_final_products.json', 'utf8'));
...
export const COMPANY_INFO = {
  ...
  alternatePhones: ["99945 72004", "97870 10042"],
...
console.log('src/data/products.js successfully written!');
